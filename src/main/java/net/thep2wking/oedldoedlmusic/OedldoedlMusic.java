package net.thep2wking.oedldoedlmusic;
...
public class OedldoedlMusic {
    public static final String MODID = "oedldoedlmusic";
    public static final String PREFIX = MODID + ":";
    public static final String MC_VERSION = "1.12.2";
    public static final String NAME = "Oedldoedl Music";
    ...
    public static final String CLIENT_PROXY_CLASS = "net.thep2wking.oedldoedlmusic.util.proxy.ClientProxy";
    public static final String SERVER_PROXY_CLASS = "net.thep2wking.oedldoedlmusic.util.proxy.ServerProxy";

    @Instance
    public static OedldoedlMusic INSTANCE;

    @SidedProxy(clientSide = CLIENT_PROXY_CLASS, serverSide = SERVER_PROXY_CLASS)
    public static CommonProxy PROXY;

	public static final CreativeTabs TAB = new CreativeTabs(OedldoedlMusic.MODID + ".name") {
		@Override
		@SideOnly(Side.CLIENT)
		public ItemStack getTabIconItem() {
			return new ItemStack(ModItems.MUSIC_ICON, 1, 0);
		}
